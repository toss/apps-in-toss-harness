...
[환경 1] pnpm dev — desktop 브라우저 + mock SDK
   ...
   │           → 폰 PWA(toss.github.io/apps-in-toss-harness/launcher/)가 ?url=<tunnel> deep-link로 iframe 로드
