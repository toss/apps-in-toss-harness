...
} from '@apps-in-toss/internal-protocol/bridge-observer-state';
...
declare global {
  interface Window {
     ...
     * a context with no observable bridge. SECRET-HANDLING: holds
 ...
 * bridge leaves `window.__ait_bridge` as an empty snapshot — the
