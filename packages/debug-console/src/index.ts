/**
 * @apps-in-toss/debug-console entry point.
 *
...
export { deriveTargetScriptUrl, detachDebugSurface, maybeAttach } from './attach.js';
export {
  BRIDGE_CALL_EVENT,
  type BridgeLastCall,
...
export { evaluateDebugGate, isPrivateAppsHost, isTossminiHost } from './gate.js';
