 ...
 * union. (`ios-pwa` — "mock SDK, real-device iOS WebKit via the launcher PWA" —
 * was the env-2 axis value; it went away with the PWA Sandbox environment,
 * harness#103.)
 *
 ...
 */
export const ALLOWED_CELL_PLATFORMS = ['mock', 'ios', 'android'] as const;
...
export async function main(argv: string[] = process.argv.slice(2)): Promise<void> {
  ...
  // platform flows into report/capture filenames). An omitted platform stays
  // undefined and gets the 'mock' default below.
