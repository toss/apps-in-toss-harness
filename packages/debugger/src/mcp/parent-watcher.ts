/**
 * Parent-PID watcher — lets the MCP debug daemon self-terminate when the parent
 * process (e.g. the agent that spawned it) has died or been reparented without
 * sending SIGTERM/SIGHUP.
 *
