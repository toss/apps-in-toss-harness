...
describe('normalizeStartDebugMode', () => {
  it('accepts the two canonical modes (relay-live #665 / relay-sandbox #103 removed)', () => {
    ...
    // relay-live / relay-sandbox no longer accepted
    expect(normalizeStartDebugMode('relay-live')).toBeNull();
    expect(normalizeStartDebugMode('relay-sandbox')).toBeNull();
  });
...
describe('isRelayMode', () => {
  it('relay-staging is relay; local-browser is not (relay-live #665 / relay-sandbox #103 removed)', () => {
