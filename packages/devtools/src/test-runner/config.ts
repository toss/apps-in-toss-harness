 ...
 *
 *   // ait-test.config.ts
 *   import { definePhoneTestConfig } from '@apps-in-toss/devtools/test-runner';
 ...
 *   import { definePhoneVitestConfig } from '@apps-in-toss/devtools/test-runner';
...
// factory straight from the `@apps-in-toss/devtools/test-runner` barrel. relay-factory
