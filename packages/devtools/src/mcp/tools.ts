...
export const DEBUG_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description:
      ...
      'devtoolsVersion (@apps-in-toss/devtools package version), tunnel (up/wssUrl/pid/startedAt), ' +
...
export interface DiagnosticsResult {
  ...
  /** `@apps-in-toss/devtools` package version string. */
...
/**
 * Returns the `@apps-in-toss/devtools` package version injected at build time via
